...
let me = {
    firstname:"ali",
    superHeroName: "Max Power",
    homeTown: 'Arlington',
    superPowers: ['lightning', 'gravity', 'earthquakes'],
...
function setColor(arr){
    faveColors.splice(0,2)
for (let i = 0; i <faveColors.length; i++){
    if (faveColors == 'blue'){
        return faveColors.splice('#4D4DFF')
    }
}
background('blue', 'black','red');
