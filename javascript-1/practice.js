...
let me = {
	...
	state:"texas",
	age:30,
	greeter: function(greeterMethod) { 
...
// Code Here
var doubled = myNumbers.map(n => n*2);
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach(function(element,index,arr){
...
// Code Here
let totallyAwesome = people.reduce(function(total,element,index, arr){
